...
<head>
    ...
    <link rel="stylesheet" href="F:\xammp2\htdocs\Baitap\php-HOTEL\admin\css\login-register.css">
        ...
        <div class="container d-flex justify-content-center align-items-center min-vh-100">
            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                    <img src="../IMG/reg2.jpg" class="img-fluid" style="border-radius: 20px; height: 450px;">
                </div>
                <!-------------------- ------ Right Box ---------------------------->
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        <div class="header-text mb-4" style="text-align: center;">
                            <a href="home.php"><img src="../IMG/poseidon-logo.png" alt=""></a>
                            <h1>Đăng nhập</h1>
                        </div>
