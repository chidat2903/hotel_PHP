...
-- INSERT INTO `offer` (`id`,`img`, `price`, `title`, `status`) VALUES
-- (1,'../IMG/1.jpg', 3300000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Quảng nam', 1052),
-- (2,'../IMG/2.jpg', 3500000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Quàng ninh', 1152),
-- (3,'../IMG/3.jpg', 1900000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (4,'../IMG/4.jpg', 3200000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (5,'../IMG/5.jpg', 3600000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (6,'../IMG/6.jpg', 3800000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (7,'../IMG/7.jpg', 3400000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (8,'../IMG/8.jpg', 3300000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (9,'../IMG/9.jpg', 4200000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (10,'../IMG/10.jpg', 3200000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (11,'../IMG/11.jpg', 5200000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252),
-- (12,'../IMG/12.jpg', 3200000, 'Combo nghỉ dưỡng 3N2D tại Đà Nẵng-Hội An', 1252);
-- =======
